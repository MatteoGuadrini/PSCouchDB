...
.. code-block:: powershell
    ...
    Get-CouchDBDatabaseChanges [[-Server] <String>] [[-Port] <Int32>] [-Database] <String> [[-Authorization] <String>] [-Ssl] [<CommonParameters>]
...
.. code-block:: powershell
    ...
    Get-CouchDBDocument [[-Server] <String>] [[-Port] <Int32>] [-Database] <String> [[-Document] <String>] [[-Revision] <String>] [-Local] [-Revisions] [-History] [[-Authorization] <String>] [-Ssl] [<CommonParameters>]
...
.. code-block:: powershell
    ...
    Get-CouchDBAttachment [[-Server] <String>] [[-Port] <Int32>] [-Database] <String> [-Document] <String> [-Attachment] <String> [[-OutFile] <String>] [[-Authorization] <String>] [-Ssl] [<CommonParameters>]
